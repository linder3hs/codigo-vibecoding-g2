...
async function list(params?: CustomerParams): Promise<PaginatedResponse<Customer>> {
...
async function update(id: number, data: Partial<CustomerCreate>): Promise<Customer> {
