...
export function CustomerTable({
  ...
  const columns = getCustomerColumns(onEdit, onDelete, perms)
    ...
    return (
      <div className="rounded-md border overflow-x-auto">
        <Table>
          <TableHeader>
            <TableRow>
              {["Cliente", "Tipo", "Email", "Ciudad", ""].map((h) => (
  ...
  return (
    <div className="space-y-4">
      ...
      <TablePagination table={table} totalCount={data?.count ?? 0} entityLabel="clientes" />
    </div>
  )
}
